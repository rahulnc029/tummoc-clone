...
import 'package:tummoc/main_page_components/change_language.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ListTile(
              onTap: () {
                Navigator.pushReplacement(context, PageRouteBuilder(pageBuilder: (context, animation, secondaryAnimation) => ChangeLanguage(),));
              },
...
//           ListTile(
//             onTap: () {
//               Navigator.pushReplacement(context as BuildContext, PageRouteBuilder(pageBuilder: (context, animation, secondaryAnimation) => ChangeLanguage(),));
//             },
//             leading: Icon(Icons.language,color: Colors.black,),
//             title: Text("Change Language",
//               style: TextStyle(
